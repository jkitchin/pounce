...
iter    objective    inf_pr   inf_du lg(mu)   ||d||  lg(rg) ...
   0    0.0000000e0  2.00e0  0.00e0  -1.0  0.00e0    -  ...
   1    1.1250000e0 5.00e-1 4.22e-9  -1.0 7.50e-1    -  ...
   2r   1.1250000e0 5.00e-1  9.99e2  -0.3  0.00e0    -  ...     ← restoration
...
iter    objective    inf_pr   inf_du lg(mu)   ||d||  lg(rg) ...  ← second inner solve
   0    3.0202000e0 9.90e-3  0.00e0  -1.0  0.00e0    -  ...
...
   6    1.5000000e0 2.22e-16 2.53e-14  -8.6 1.88e-6  -  ...     ← wrapper converges
                                                                  in the slacked
                                                                  problem
EXIT: Converged to a point of local infeasibility. Problem may be infeasible.
```
