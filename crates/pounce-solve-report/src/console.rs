...
/// Evaluation-callback tallies for the end-of-run summary, decoupled
/// from any particular TNLP wrapper so both the CLI's `CountingTnlp`
/// and the Python bindings' callback problem can supply them.
