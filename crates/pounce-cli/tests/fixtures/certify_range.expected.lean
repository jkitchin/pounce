...
namespace PounceLean.CertifyRange
...
def nlSha256  : String := "fa599febe64fd450951bd000381b0bc9e6318e9f1a17f0656a40e5ae1adadea9"
def solSha256 : String := "029840db026267396fef3e7ca43ea846d6d9cb296e60497fd26827d61cfe9ae0"

/-! ### Problem data, transcribed from the certificate. -/

def Qdiag : Fin 2 → ℚ := ![2, 2]
def Q : Matrix (Fin 2) (Fin 2) ℚ := Matrix.diagonal Qdiag
def cvec : Fin 2 → ℚ := ![-6, -6]
def kconst : ℚ := 18
def Amat : Matrix (Fin 2) (Fin 2) ℚ := !![1, 1; -1, -1]
def bvec : Fin 2 → ℚ := ![1, -4]
def xstar : Fin 2 → ℚ := ![2, 2]
def lamv : Fin 2 → ℚ := ![0, 2]
...
theorem candidate_objective : obj Q cvec kconst xstar = 2 := by
