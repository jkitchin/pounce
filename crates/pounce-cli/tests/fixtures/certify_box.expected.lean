...
namespace PounceLean.CertifyBox
...
def nlSha256  : String := "954c42ae9ac363b2fbd0a1b8beb7f4d6c0da9d26fe7f20259c710db39aca7e1f"
def solSha256 : String := "e5cf3eb55ef280a0d42c3da8a7a46c9ca89016a9c95307d84aa88c1574582408"

/-! ### Problem data, transcribed from the certificate. -/

def Qdiag : Fin 2 → ℚ := ![2, 2]
def Q : Matrix (Fin 2) (Fin 2) ℚ := Matrix.diagonal Qdiag
def cvec : Fin 2 → ℚ := ![-6, -8]
def kconst : ℚ := 25
def Amat : Matrix (Fin 3) (Fin 2) ℚ := !![1, 0; -1, 0; 0, 1]
def bvec : Fin 3 → ℚ := ![0, -1, 0]
def xstar : Fin 2 → ℚ := ![1, 4]
def lamv : Fin 3 → ℚ := ![0, 4, 0]
...
theorem candidate_objective : obj Q cvec kconst xstar = 4 := by
