...
-- The obligation the LP slice never had: `d` must lie exactly in ker Q.
-- A float direction misses this, so the producer projects `d` onto ker Q
-- over ℚ before emitting it.
